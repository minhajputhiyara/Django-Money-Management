...
urlpatterns = [
    ...
    path('expenses/export_csv', views.export_csv, name="export-csv"),
    path('expenses/export_excel', views.export_excel, name="export-excel"),
    path('expenses/export_pdf', views.single_inc_pdf_download.as_view(), name="export-pdf"),
]
